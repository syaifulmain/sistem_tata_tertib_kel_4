    ...
    <div class="d-flex">
        <nav class="sidebar">
            <div>
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link <?php echo $page == 'dashboard' ? 'active' : ''; ?> text-white" href="?page=dashboard">
                            <i class="fas fa-th-large icon-spacing"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $page == 'lapor' ? 'active' : ''; ?> text-white" href="?page=lapor">
                            <i class="fas fa-exclamation-circle icon-spacing"></i> Lapor
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $page == 'pelanggaran' ? 'active' : ''; ?> text-white" href="?page=pelanggaran">
                            <i class="fas fa-ban icon-spacing"></i> Pelanggaran
                        </a>
                    </li>
                </ul>
